<template>
  ...
  <div class="release-page">
    ...
    <div style="display: flex;margin-left: 0.5rem;margin-right: 0.5rem;flex-direction: column">
      <div style="display: flex;flex-direction: column;margin-right: 0.5rem;width: calc(60% + 0.1rem);">
        <div style="display: flex;align-items: center;margin-top: 0.2rem;">
          <div class="main-title">Product Name:</div>
          <el-input class="main-input" v-model="distributionFrom.goodsTitle" placeholder="Please enter the product name"></el-input>
        </div>

        <div style="display: flex;align-items: center;margin-top: 0.2rem;">
          <p class="main-title">Product Introduction:</p>
          <el-input class="main-input" v-model="distributionFrom.goodsIntro" placeholder="Please enter the product introduction"></el-input>
        </div>

        <div style="display: flex;margin-top: 0.2rem;">
          <p class="main-title">Product Description:</p>
          <el-input class="main-input" type="textarea" :autosize="{ minRows: 2}" v-model="distributionFrom.goodsDetailsIntro" placeholder="Please enter the product description"></el-input>
        </div>
      </div>
    </div>
    ...
    <el-checkbox v-model="checked" style="margin-top: 0.2rem;margin-left: 0.5rem;">Understand the distribution rules, group buying and haggling rules set by yourself。</el-checkbox>

    <div class="buy-button" :class="{'enable':checked && formValid && imageValid}" @click="rulesConfirm()">Publish Product</div>
...
import { publishProduct} from "@/api";
import RulesConfirmDialog from "@/pages/product/RulesConfirmDialog";
...
export default {
  ...
  methods:{
    initProductDetail(){
      this.distributionFrom.goodsTitle = "Fidenza#604";
      this.distributionFrom.goodsIntro = "Fidenza by Tyler Hobbs";
      this.distributionFrom.goodsDetailsIntro = "Fidenza is by far my most versatile algorithm to date. Although the program stays focused on structured curves and blocks, the varieties of scale, organization, texture, and color usage it can employ create a wide array of generative possibilities.";
      this.distributionFrom.goodsSalePrice = "148613.85";
      this.distributionFrom.goodsPrice = "150000.00";

      this.distributionFrom.price = "140000.00";
      this.distributionFrom.participantsMin = "3";
      this.distributionFrom.participantsMax = "5";
      this.distributionFrom.ownerRewardRatio = "0.03";
      this.distributionFrom.blindBoxTotalRewardAmount = "1000";
      this.distributionFrom.expirationDay = "10";
      this.distributionFrom.haggleMinAmount = "2";
      this.distributionFrom.haggleMaxAmount = "10";
      this.distributionFrom.haggleRewardAmount = "10";

      this.distributionFrom.distributionMin = "5";
      this.distributionFrom.distributionPrice = "145000.00";
      this.distributionFrom.pledgeAmount = "1450000.00";
      this.distributionFrom.distributionRewardRatio = "0.05";
      this.distributionFrom.penaltyRatio = "0.1";
      this.distributionFrom.distributionExpirationDay = "50";
    },
    ...
    publishProduct(){
      ...
      publishProduct(formData).then(res => {
